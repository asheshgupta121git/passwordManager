...
const Manager = () => {
  ...
  return (
    <>
      ...
      {/* Same as */}
      <ToastContainer />
      <div className="absolute inset-0 -z-10 h-full w-full bg-slate-200 bg-[linear-gradient(to_right,#fff_1px,transparent_1px),linear-gradient(to_bottom,#fff_1px,transparent_1px)] bg-[size:6rem_4rem]">
      ...
      <div className="p-3 md:mycontainer min-h-[87vh]">
        ...
        <p className="text-lg text-center font-bold">Your Password manager</p>
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          <input
            ...
            className="rounded-full border-2 bg-slate-50 border-blue-500 w-full p-4 py-1"
            type="text"
            name="site"
            id="site"
          />
          ...
          <button
            ...
            className="flex justify-center items-center gap-2 bg-slate-400 rounded-full px-4 py-2 w-fit hover:bg-slate-200 border-2 border-blue-400"
          >
            <lord-icon
